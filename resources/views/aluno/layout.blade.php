...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styleAluno.css') }}">
    <style>
    </style>
</head>
<body>
    <div class="sidebar d-none d-md-flex sticky-top">
        ...
        <a id="op" href="{{ route('alunoPerfil') }}" class=""><i class="bi bi-person-fill"></i><span> Perfil</span></a>
        <a id="op" href="{{ route('alunoNotifi') }}" class=""><i class="bi bi-bell-fill"></i><span> Notificação</span></a>
    ...
    <div class="bottom-menu d-md-none">
        <a href="{{ route('alunoHome') }}" class=""><i class="bi bi-house-fill"></i><span>Home</span></a>
        ...
        <a href="#"><i class="bi bi-box-arrow-right-fill"></i><span>Sair</span></a>
    </div>
